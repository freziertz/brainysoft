...
$directorNumber = 0 ;//	$rowSetting['directornumber'];
$addressNumber =  0	;//$rowSetting['addressnumber'];
$identityNumber = 0	;//$rowSetting['identitynumber'];
$identityDirectorNumber = 0;//	$rowSetting['identitydirectornumber'];
$securityNumber = 	0;//$rowSetting['securitynumber'];
$contractNumber = 	0;//$rowSetting['contractnumber'];
$guarantorNumber = 	0;//$rowSetting['guarantornumber'];
