...
$guarantorNumber = 	$rowSetting['guarantornumber'];
	...
	$sqlSelectLoanApplications = ("SELECT organizationid,
...
$location = "Organization List";
$title = "Organization List";
$breadcumb ="Organization List";
$breadcumbDescription=" View Organization details, physical address, director and request loan";
$currentSymbo = "TZS";
